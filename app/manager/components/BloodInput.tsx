  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (exists) {
        ...
        showToast("এই নম্বরটি আগে থেকেই নিবন্ধিত আছে", 'error');
        setLoading(false);
        return;
      }
      ...
      setForm(empty);
      setErrors({});
      showToast("রক্তদাতা সফলভাবে যোগ করা হয়েছে!", 'success');
    } catch (err) {
      console.error("Failed to add donor:", err);
      showToast("দুঃখিত! রক্তদাতা যোগ করতে ব্যর্থ হয়েছে", 'error');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <div className="w-full max-w-lg">
          ...
          <div className="bg-white/3 border border-white/8 rounded-2xl p-6 md:p-8 space-y-4">
            ...
            >
              {loading ? "সংরক্ষণ করা হচ্ছে..." : "🩸 রক্তদাতা যোগ করুন"}
            </button>
